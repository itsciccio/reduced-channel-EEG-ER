...
cwd = str(os.getcwd())
if dependency == "independent": dir_path = cwd+f"/result_stacked{custom_dir}/{channel_dir}chan/{length_dir}sec/{with_or_not}/{kernel_size}x{kernel_size}/{arousal_or_valence}/independent/"
else: dir_path = cwd+f"/result_stacked{custom_dir}/{channel_dir}chan/{length_dir}sec/{with_or_not}/{kernel_size}x{kernel_size}/{arousal_or_valence}/"
